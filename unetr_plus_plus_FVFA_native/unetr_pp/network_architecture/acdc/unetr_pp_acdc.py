...
class UNETR_PP(SegmentationNetwork):
    ...
    def __init__(
        ...
        self.decoder5 = UnetrUpBlock(
            ...
            norm_name=norm_name,
            out_size=4*10*10,
            input_resolution=(4,10,10),
            stage=2,
            sr_ratios=2
        )
        #self.unetr_pp_encoder.pass_relative_pos(self.decoder5)
        ...
        self.decoder4 = UnetrUpBlock(
            ...
            norm_name=norm_name,
            out_size=8*20*20,
            input_resolution=(8,20,20),
            stage=1,
            sr_ratios=4
        )
        #self.unetr_pp_encoder.pass_relative_pos(self.decoder4)
        self.decoder3 = UnetrUpBlock(
            ...
            norm_name=norm_name,
            out_size=16*40*40,
            input_resolution=(16,40,40),
            stage=0,
            sr_ratios=8
        )
        #self.unetr_pp_encoder.pass_relative_pos(self.decoder3)
