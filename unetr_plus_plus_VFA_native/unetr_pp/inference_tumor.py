...
def test(fold):
    ...
    path = "/mnt/lustre/users/sntanzi/unetr_plus_plus_6/DATASET_Tumor/unetr_pp_raw/unetr_pp_raw_data/Task03_tumor/"    
    
    label_list=sorted(glob.glob(os.path.join(path,'labelsTs','*nii.gz')))

    infer_path = "/mnt/lustre/users/sntanzi/unetr_plus_plus_4_native/unetr_pp/evaluation/unetr_pp_tumor_checkpoint/"
